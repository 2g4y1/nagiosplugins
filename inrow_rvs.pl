...
my @oids = ($oid_thresh_inlet_temp, $oid_thresh_supply_temp, $oid_thresh_return_temp, $oid_inlet_temp, $oid_supply_temp, $oid_return_temp, $oid_cool_demand, $oid_cool_output, $oid_airflow);
